<section class="behind">
    <div class="behind_container">
        <div class="left-column">
            <img src="<?php echo get_stylesheet_directory_uri() ?>/dev/dist/res/img/assets/behind-left.webp" alt="">
        </div>
        <div class="right-column">
            <h3 class="d-title">
                The Ones <br> behind IT
            </h3>
            <p class="d-text">
                Investimos significativamente na capacitação técnica do nosso time de especialistas, que é altamente
